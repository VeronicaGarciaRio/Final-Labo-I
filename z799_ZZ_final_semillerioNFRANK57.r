...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990viejoperonuevoR57"
PARAM$exp_input  <- "HT6510_1k2meses"

#Atencion, que cada modelos se procesa con 5 semillas, ajuste a SUS necesidades
PARAM$modelos_rank  <- c( 57 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 200   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 100169  # se utiliza para generar el vector de  PARAM$semillerio  semillas
